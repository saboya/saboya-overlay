...
src_install(){
	...
	make_desktop_entry "${PN} %F" "Visual Studio Code" "${PN}" "Development;IDE"
	#make_desktop_entry "${targetdir}/bin/code %F" "Visual Studio Code" "${PN}" "Development;IDE" "Path=${targetdir}/bin"
